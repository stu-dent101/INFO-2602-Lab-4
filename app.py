...
# View Routes - rendering a template, GET request, return a UI


@app.route('/', methods=['GET'])
@app.route('/login', methods=['GET'])
def login_page():
  return render_template('login.html') #accessing the page

@app.route('/app', methods=['GET'])
@jwt_required() #for it a route requires authentication
def todos_page():
...
#not getting the list on the edit page to show up, I tried doing todos = current_user.get_todos() in the edit html and in here but it would still look the same, or it would say current_user undefined
...
# Action Routes - responds to when a link is clicked or when a form is submitted, by preforming somme action and redirecting the user to a view route
